...
TODO: define if individual contributor license agreement is needed.
...
```console
export GIT_ACCOUNT=DHEPLab
export GIT_REPOSITORY=aim-ahead-platform
```
...
FOR NOW EVERYTHING IS TRUNK BASED DEVELOPMENT. AFTER v1.0.0, WE WILL REVISIT TO IDENTIFY THE BEST BRANCHING STRATEGY. FOR NOW, THE BELOW IS NOT RELEVANT.
...
Accepting pull requests will be at the discretion of DHEPLab and the repository owner(s).
